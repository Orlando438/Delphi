...
try
  ...
  begin
    if (CheckBoxCNPJ.Checked) then
      begin
       if (not ValidaCnpj(RetiraCaracteresNaoNumericos(Trim(query.FieldByName('IDDOCIDENT').AsString)))) then
      ...
      begin
       if (not VAlidaCpf(RetiraCaracteresNaoNumericos(Trim(query.FieldByName('IDDOCIDENT').AsString)))) then
